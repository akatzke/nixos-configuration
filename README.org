...
Even though almost the entirety of the source code blocks gets exported to the ~nix~ files [[file:configuration.nix]] (the system-wide configuration) and [[file:hephaestus-home.nix]] (the user-configuration for my desktop PC),
