...
#+end_src
#+begin_src nix :noweb-ref '(orpheus sisyphus)
...
For my desktop, set it to the international version of the US layout for my lily58.
#+begin_src nix :noweb-ref hephaestus
services.xserver = {
  layout = "us";
...
Set keyboard layout for =sisyphus=
#+begin_src nix :noweb-ref sisyphus
services.xserver = {
  layout = "us";
  xkbVariant = "altgr-intl";
...
* Home Manager
:PROPERTIES:
:header-args: :results none :tangle home-manager/hephaestus.nix
:END:
